...
public class Analytics {
    ...
    public static void registerExtension() {
        MobileCore.registerExtension(AnalyticsExtension.class, extensionError -> {
            ...
            Log.error(LOG_TAG, LOG_TAG, "There was an error when registering the Analytics extension: %s", extensionError.getErrorName());
        });
    }
    ...
    public static void getTrackingIdentifier(final AdobeCallback<String> callback) {
        ...
        final Event analyticsReqEvent = new Event.Builder("GetTrackingIdentifier", EventType.ANALYTICS, EventSource.REQUEST_IDENTITY).build();
        MobileCore.dispatchEventWithResponseCallback(analyticsReqEvent, EVENT_PROCESSING_TIMEOUT_MS, new AdobeCallbackWithError<Event>() {

            @Override
            public void call(Event event) {
                Map<String, Object> eventData = event.getEventData();
                callback.call(eventData != null ? DataReader.optString(eventData, ANALYTICS_ID, null) : null);
            }
        ...
        Log.debug(LOG_TAG, LOG_TAG, "getTrackingIdentifier - Get tracking identifier request event was sent");
    }
    ...
    public static void getQueueSize(final AdobeCallback<Long> callback) {
        ...
        final Event analyticsReqEvent = new Event.Builder("GetQueueSize", EventType.ANALYTICS, EventSource.REQUEST_CONTENT).setEventData(eventDataMap).build();
        MobileCore.dispatchEventWithResponseCallback(analyticsReqEvent, EVENT_PROCESSING_TIMEOUT_MS, new AdobeCallbackWithError<Event>() {

            @Override
            public void call(Event event) {
                Map<String, Object> eventData = event.getEventData();
                callback.call(eventData != null ? DataReader.optLong(eventData, QUEUE_SIZE, 0L) : 0L);
            }
    ...
    public static void clearQueue() {
        ...
        MobileCore.dispatchEvent(new Event.Builder("ClearHitsQueue", EventType.ANALYTICS, EventSource.REQUEST_CONTENT).setEventData(eventDataMap).build());
    ...
    public static void sendQueuedHits() {
        ...
        MobileCore.dispatchEvent(new Event.Builder("ForceKickHits", EventType.ANALYTICS, EventSource.REQUEST_CONTENT).setEventData(eventDataMap).build());
    ...
    public static void getVisitorIdentifier(final AdobeCallback<String> callback) {
        ...
        final Event analyticsReqEvent = new Event.Builder("GetVisitorIdentifier", EventType.ANALYTICS, EventSource.REQUEST_IDENTITY).build();
        ...
        MobileCore.dispatchEventWithResponseCallback(analyticsReqEvent, EVENT_PROCESSING_TIMEOUT_MS, new AdobeCallbackWithError<Event>() {
            ...
            public void call(Event event) {
                Map<String, Object> eventData = event.getEventData();
                callback.call(eventData != null ? DataReader.optString(eventData, VISITOR_IDENTIFIER, null) : null);
            }
