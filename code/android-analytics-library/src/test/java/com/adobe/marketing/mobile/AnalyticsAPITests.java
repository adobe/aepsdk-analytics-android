...
public class AnalyticsAPITests {
    ...
    public void testClearQueue() {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEvent(eventCaptor.capture()));
    ...
    public void testGetQueueSizeWithNullCallback() {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            ArgumentCaptor<Event> eventCaptor = ArgumentCaptor.forClass(Event.class);
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEvent(eventCaptor.capture()), never());
        }
    ...
    public void testGetQueueSize() throws InterruptedException {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEventWithResponseCallback(eventCaptor.capture(), anyLong(), callbackCaptor.capture()), times(1));
            AdobeCallbackWithError callback = callbackCaptor.getValue();
            callback.call(new Event.Builder("", "", "").setEventData(Collections.singletonMap("queuesize", 5)).build());
    ...
    public void testGetTrackingIdentifier() throws InterruptedException {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEventWithResponseCallback(eventCaptor.capture(), anyLong(), callbackCaptor.capture()), times(1));
            AdobeCallbackWithError callback = callbackCaptor.getValue();
            callback.call(new Event.Builder("", "", "").setEventData(Collections.singletonMap("aid", "aid_1")).build());
            countDownLatch.await();
        }
    }
    ...
    public void testGetTrackingIdentifierWithBadResponse() throws InterruptedException {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEventWithResponseCallback(eventCaptor.capture(), anyLong(), callbackCaptor.capture()), times(1));
            AdobeCallbackWithError callback = callbackCaptor.getValue();
            callback.call(new Event.Builder("", "", "").setEventData(Collections.singletonMap("x", "aid_1")).build());
            countDownLatch.await();
        }
    }
    ...
    public void testGetVisitorIdentifier() throws InterruptedException {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEventWithResponseCallback(eventCaptor.capture(), anyLong(), callbackCaptor.capture()), times(1));
            AdobeCallbackWithError callback = callbackCaptor.getValue();
            callback.call(new Event.Builder("", "", "").setEventData(Collections.singletonMap("vid", "vid_1")).build());
            countDownLatch.await();
        }
    }
    ...
    public void testGetVisitorIdentifierWithBadResponse() throws InterruptedException {
        try (MockedStatic<MobileCore> mobileCoreMockedStatic = Mockito.mockStatic(MobileCore.class)) {
            ...
            mobileCoreMockedStatic
                    .verify(() -> MobileCore.dispatchEventWithResponseCallback(eventCaptor.capture(), anyLong(), callbackCaptor.capture()), times(1));
            AdobeCallbackWithError callback = callbackCaptor.getValue();
            callback.call(new Event.Builder("", "", "").setEventData(Collections.singletonMap("x", "vid_1")).build());
            countDownLatch.await();
        }
    }
